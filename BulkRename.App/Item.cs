...
namespace BulkRename.App
{
    ...
    public class Item
    {
        ...
        /// <summary>
        /// Rename item to a name generated by the specified generator, checking for duplicate names before renaming.
        /// </summary>
        /// <param name="tempNameGen"></param>
        /// <exception cref="IOException"></exception>
        public void MoveToTempName(Func<int, string> tempNameGen)
        {
            var loopCount = 0;
            while (true) {
                if (loopCount > 10000) throw new IOException("Maximum temporary name limit reached.");
                loopCount++;
                var tmpName = tempNameGen(Name.Length);
                var tmpPath = Path.Combine(ParentPath, tmpName);
